...
app.factory('tokensManagerService', ['$http', 'ngAuthSettings', function ($http, ngAuthSettings) {
    ...
    var _getRefreshTokens = function () {
        ...
        return $http.get(serviceBase + 'api/refreshtokens').then(function (resultados) {
            return resultados;
        });
    };
    ...
    var _deleteRefreshTokens = function (tokenid) {
        ...
        return $http.delete(serviceBase + 'api/refreshtokens/?tokenid=' + tokenid).then(function (resultados) {
            return resultados;
        });
    };
